...
#ifndef ESPPROVISION_SWIFT_H
#define ESPPROVISION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ESPProvision",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// Provide option to
SWIFT_CLASS("_TtC12ESPProvision19ESPProvisionManager")
